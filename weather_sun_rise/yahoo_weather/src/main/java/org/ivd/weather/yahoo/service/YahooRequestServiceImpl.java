 ...
 */
@RequestScoped
public class YahooRequestServiceImpl implements YahooRequestService {
    private final Logger LOG = LoggerFactory.getLogger(YahooRequestServiceImpl.class);
    ...
    private String getSignature(String signatureString) throws WeatherException {
        try {
            ...
            throw new WeatherException("YahooRequestServiceImpl (getAuthorizationString()) ->", e);
        }
    }
